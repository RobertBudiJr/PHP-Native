...
$qry_spp=mysqli_query($conn,"select * from spp ORDER BY `spp`.`id_spp` ASC");
        ...
        <tr>              
            ...
            <td><a href="ubah_data_spp.php?id_spp=<?=$data_spp['id_spp']?>" class="btn btn-warning">Ubah</a> | 
                <a href="hapus_data_spp.php?id_spp=<?=$data_spp['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
